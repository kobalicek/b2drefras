...
class RasterizerAGG : public Rasterizer {
public:
  RasterizerAGG(Image& dst, uint32_t options) noexcept;
  virtual ~RasterizerAGG() noexcept;
  ...
  typedef agg::pixfmt_bgra32_pre AGGPixelFormat;
  typedef agg::rasterizer_scanline_aa<> AGGRasterizer;
  typedef agg::renderer_base<AGGPixelFormat> AGGRendererBase;
  typedef agg::renderer_scanline_aa_solid<AGGRendererBase> AGGRendererSolid;
  typedef agg::rendering_buffer AGGRenderingBuffer;

  AGGRenderingBuffer _rbuf;
  AGGPixelFormat _pixfmt;
  AGGRendererBase _baseRenderer;
  AGGRendererSolid _solidRenderer;
  AGGRasterizer _rasterizer;
  agg::scanline_p8 _scanline;
};

// ============================================================================
// [RasterizerAGG - Construction / Destruction]
// ============================================================================
...
RasterizerAGG::~RasterizerAGG() noexcept {
  reset();
}

// ============================================================================
// [RasterizerAGG - Basics]
// ============================================================================

void RasterizerAGG::reset() noexcept {}
void RasterizerAGG::clear() noexcept {}

// ============================================================================
// [RasterizerAGG - AddPoly / AddLine]
// ============================================================================
...
// ============================================================================
// [RasterizerAGG - Render]
// ============================================================================

void RasterizerAGG::render(uint32_t argb32) noexcept {
  _solidRenderer.color(
    agg::rgba8((argb32 >> 16) & 0xFF,
               (argb32 >>  8) & 0xFF,
               (argb32      ) & 0xFF, 0xFF));

  _rasterizer.filling_rule(fillMode() == kFillNonZero ? agg::fill_non_zero : agg::fill_even_odd);
  agg::render_scanlines(_rasterizer, _scanline, _solidRenderer);
  _rasterizer.reset();
}
...
Rasterizer* newRasterizerAGG(Image& dst, uint32_t options) noexcept {
  return new(std::nothrow) RasterizerAGG(dst, options);
}
